    ...
    <Swiper  
        ...
        <SwiperSlide>
          <div className='scriptPage'>
            <div/>
            <img src={e31} className='scriptImg' alt=''/>
        ...
        <SwiperSlide>
          ...
          <div className='scriptPage'>
            <img src={e32} className='scriptImg' alt=''/> 
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className='scriptPage'>
            <img src={e33} className='scriptImg' alt=''/> 
          </div>
        </SwiperSlide>
      </Swiper>
...
export default ElliIvyScript2step3;
