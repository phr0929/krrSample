...
import "swiper/css"
import krrMotion from './resource/krrmotion.mp4'
import noimage from './resource/noimage.png'
...
function NextTime() {
  ...
  return (
    ...
    See you next year.
      <div className='nexttimeLayout'>
        <div className='comingsoon'>
          신학기<br/> 
          <div style={{display:'flex',flexDirection:'row',textAlign:'center',justifyContent:'center'}}>
            <div style={{color:'#fff',cursor:'none'}}>
              !
            </div>
            준비중입니다.
          </div>
        </div>
        <div className='comingsoonContents'>2026년도 영업시즌에 다시 만나요!</div>
        <video  className='comingsoonCharacter'  autoPlay muted loop poster={noimage}>
          <source src={krrMotion} type="video/mp4"></source>
        </video>
        {/* <div className='comngsoonSiteBtn'>섬김 사이트 바로가기</div> */}
      </div>
