      ...
      <div className='menuBar'>
        <div className='menuBarIn'>
          ...
          <div className='navMenuBar'>
            <div className='navTitleKrr' style={{marginRight:0,color:'#39a1db'}}>
              까르르 스피치 2호 대본
            </div> 
          </div>
        </div>
    ...
    <Swiper  
        ...
        <SwiperSlide>
          <div className='scriptPage'>
            <div/>
            <img src={h31} className='scriptImg' alt=''/>
        ...
        <SwiperSlide>
          ...
          <div className='scriptPage'>
            <img src={h32} className='scriptImg' alt=''/> 
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className='scriptPage'>
            <img src={h33} className='scriptImg' alt=''/> 
          </div>
        </SwiperSlide>
      </Swiper>
...
export default KrrScript2step3;
