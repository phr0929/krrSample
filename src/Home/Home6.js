import '../App.css';
import krrLogo from '../resource/krr math logo.svg';
    ...
    <div className='listLayoutHome'>
      ...
      <div style={{width:900,height:'100%',backgroundColor:'#fff'}}>
        <div className='listTitleBarHome'>
          <img src={krrLogo} alt='' style={{width:170,maxWidth:'35%'}}/>
          <div>
            6호 가정안내문
          </div>
        </div>
        ...
        {/* <div style={{display:'flex',flexDirection:'row',width:'100%',padding:'10px 20px',boxSizing:'border-box',}}>
          <div onClick={()=>navigate('../Home/H16eww')} style={{display:'flex',flexDirection:'column',alignItems:'center',fontSize:14,flex:1,}}>
            <img src={krrStepOn1} alt='' style={{width:60,height:60,marginBottom:10}}/>
            <span>한글 STPE1</span>
          </div>

          <div onClick={()=>navigate('../Home/H26abd')} style={{display:'flex',flexDirection:'column',alignItems:'center',fontSize:14,flex:1}}>
            <img src={krrStepOn2} alt='' style={{width:60,height:60,marginBottom:10}}/>
            <span>한글 STPE2</span>
          </div>

          <div onClick={()=>navigate('../Home/H36esd')} style={{display:'flex',flexDirection:'column',alignItems:'center',fontSize:14,flex:1}}>
        ...
        // ,marginTop:10
          ...
          <div onClick={()=>navigate('../Home/M16pwe')} style={{display:'flex',flexDirection:'column',alignItems:'center',fontSize:14,flex:1,}}>
            <img src={krrMath1} alt='' style={{width:60,height:60,marginBottom:10}}/>
            <span>수학 STPE1</span>
          </div>

          <div onClick={()=>navigate('../Home/M26wws')} style={{display:'flex',flexDirection:'column',alignItems:'center',fontSize:14,flex:1}}>
            <img src={krrMath2} alt='' style={{width:60,height:60,marginBottom:10}}/>
            <span>수학 STPE2</span>
          </div>

          <div onClick={()=>navigate('../Home/M36zzv')} style={{display:'flex',flexDirection:'column',alignItems:'center',fontSize:14,flex:1}}>
