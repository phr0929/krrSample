...
import zemboImg from './resource/10/zembo1.png'
import bookVideo from './resource/10/h1video.png'
import book from './resource/step1book.png'
import video1 from './resource/10/h1_1.png'
import video2 from './resource/10/h1_2.png'
import video3 from './resource/10/h1_3.png'
import video4 from './resource/10/h1_4.png'
import video5 from './resource/10/h1_5.png'
import video6 from './resource/10/h1_6.png'
import video7 from './resource/10/h1_7.png'
import video8 from './resource/10/h1_8.png'
...
function H1_10() {
  ...
  const linkList = [
    ...
    {page:2, link:'https://youtu.be/bmc-1KPsZNQ',img:video2},
    {page:10,link:'https://youtu.be/K1w_0DxiLYA',img:video3},
    {page:10,link:'https://youtu.be/FoMHHv7IeJI',img:video4},
    {page:12,link:'https://youtu.be/d1Ooza1wE4U',img:video5},
    {page:12,link:'https://youtu.be/plz_2IRWsd0',img:video6},
    {page:14,link:'https://youtu.be/fNVKLkJXN54',img:video7},
    {page:14,link:'https://youtu.be/F0vnOHM6D7E',img:video8},  
   ]

  const [zembo, setZembo] = useState({
    title:'나랑 바꿀래?',
    title2:'',
    contents:'『나랑 바꿀래?』는 주인공이 다른 아이의 물건을 부러워하다가 결국 자기 것의 소중함을 깨닫는 이야기입니다. 이 책은 아이들이 자존감을 키우고 자신이 가진 것을 소중히 여기는 마음을 배우도록 도와줍니다.',
    img:zemboImg,
    link:'https://youtu.be/SIq1k2SWsEI'
  }) 
