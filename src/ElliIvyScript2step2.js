    ...
    <Swiper  
        ...
        <SwiperSlide>
          <div className='scriptPage'>
            <div/>
            <img src={e21} className='scriptImg' alt=''/>
        ...
        <SwiperSlide>
          ...
          <div className='scriptPage'>
            <img src={e22} className='scriptImg' alt=''/> 
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className='scriptPage'>
            <img src={e23} className='scriptImg' alt=''/> 
          </div>
        </SwiperSlide>
      </Swiper>
...
export default ElliIvyScript2step2;
